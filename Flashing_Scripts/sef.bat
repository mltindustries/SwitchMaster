...
if not exist keys\SMv2_SBv2_signing_key.pem (
echo SecureBoot V2 KEY not found in key folder or need to rename it to sm_flash_encryption_key.bin
goto end
)
espsecure sign_data --version 2 --keyfile keys\SMv2_SBv2_signing_key.pem --output binaries\mlt-sw-v2.bin binaries\firmware.bin
