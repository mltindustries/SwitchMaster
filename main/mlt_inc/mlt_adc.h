#define VREF_SM           5.0
#define VREF_MAXI         3.3
#define ADC_STEPS       8388607.0     // 23 bits
#define diodeoffset     0.26
#define I2C_SDA_IO      21
#define I2C_SCL_IO      22

#define SAMPLE_RATE_MASK  0x30      // 80 samples per second

#define ADC_CHANNEL_V     0x00      // Ch 1, voltage
#define ADC_CHANNEL_A     0x80      // Ch 2, current


//
// NAU7802 registers, bitmasks and constants
//
...
//
// calculate and return voltage in 10mV steps
//
float adc_get_voltage(void);

//
// calculate and return current in 10mA steps
//
